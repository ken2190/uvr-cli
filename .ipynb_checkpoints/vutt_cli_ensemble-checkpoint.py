...
class UVR_CLI:
    ...
    def process(self, input_path, model_name, arch, setting1, setting2,ensemble_model_manual_list=None, progress=None):
        # def set_progress_func(step, inference_iterations=0):
        #     progress_curr = step + inference_iterations
        #     progress(progress_curr)

        # # sampling_rate, audio = input_audio
        # audio, sampling_rate = input_audio
        ...
        seperator = uvr.process(
            ...
            ensemble_model_manual_list=ensemble_model_manual_list,
            # export_path = "__temp"
...
if __name__=="__main__":
    ...
    webui = UVR_CLI(uvr, online_data_path='models/download_checks.json')
    path = "./9OvlclzngLY.wav"
    input_audio = librosa.load(path)
    # out = webui.process(input_path="5bV0z3KYVw8_S0_E300.wav",
    #                         model_name="2_HP-UVR",
    #                         arch="VR Arc",
    #                         setting1=512,
    #                         setting2=10,
    ...
    out = webui.process(input_path="5bV0z3KYVw8_S0_E300.wav",
                            model_name=None,
                            ensemble_model_manual_list=["3_HP-Vocal-UVR", "4_HP-Vocal-UVR"],
                            arch="Ensemble Mode",
                            setting1=512,
                            setting2=10,
    ...
    #         for i, (model_name, model_url) in enumerate(models.items()):
    #             print(model_name)
            
    #             # print(f"VUTT modelname: {model_name}")
